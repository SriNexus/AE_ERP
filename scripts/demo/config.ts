import {DEMO_COMPANY_ID,DEMO_ERP_USER_ID,DEMO_GROUP_ID,DEMO_ID_PREFIX,DEMO_ROLE_ID,DEMO_SEED_ID,OFFICIAL_DEMO_EMAIL,demoDocumentId} from '../../src/config/demo.ts';
export {DEMO_COMPANY_ID,DEMO_ERP_USER_ID,DEMO_GROUP_ID,DEMO_ID_PREFIX,DEMO_ROLE_ID,DEMO_SEED_ID,OFFICIAL_DEMO_EMAIL,demoDocumentId};

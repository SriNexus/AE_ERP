/**
 * Installation workspace configuration — tab definitions
 *
 * Phase 7B — Installation Workspace
...
// ── Installation tab definitions ────────────────────────────
export const INSTALLATION_TABS: TabDefinition[] = [

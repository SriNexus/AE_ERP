/**
 * Net Metering workspace configuration — tab definitions
 *
 * Phase 7E — Net Metering Workspace
...
// ── Net Metering tab definitions ───────────────────────────
export const NET_METERING_TABS: TabDefinition[] = [
